...
install_small8() {
    ./scripts/feeds install -p small8 -f xray-core xray-plugin dns2tcp dns2socks haproxy hysteria \
        ...
        lucky luci-app-lucky luci-app-openclash luci-app-homeproxy homebox luci-app-netspeedtest \
        luci-app-amlogic nikki luci-app-nikki tailscale luci-app-tailscale oaf open-app-filter luci-app-oaf \
        luci-theme-argon luci-theme-argon-config easytier luci-app-easytier msd_lite luci-app-msd_lite
}
